...
const projects = [
    { title: "FastFlow Schedule Management", description: "My Thesis Topic: Using Linux Scheduling (real-time) for FasFlow library (threads parallelism)", image: "/images/projects/fastflow.webp", link: "https://github.com/Marco-Skiavone/fastflow", when: 2025 },
    ...
    { title: "Thread Programming", description: "Threaded Mailing List Management (in Java + JavaFX)", image: "/images/projects/threads.webp", link: "https://github.com/Marco-Skiavone/Programming-3-Project", when: 2024 },
