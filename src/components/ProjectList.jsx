...
const projects = [
    ...
    { title: "Data Analisys", description: "Overview of Pandas, Seaborn & other tools", image: "/images/projects/data_an.webp", link: "#", when: 2024 },
            ...
            <Container>
                ...
                <Row>
                    {projects.map((project, index) => (
                        <Col key={index} className="col-12 col-sm-12 col-md-6 col-lg-4 mb-4">
                            <ProjectCard {...project} />
                        </Col>
                    ))}
                </Row>
